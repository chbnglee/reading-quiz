...
def build_quiz() -> dict:
    ...
    questions = [
        ...
        },
        {
            ...
            "interaction": {
                ...
                "items": [
                    ...
                    {"key": "resting", "text": "be in his bed", "slot": "at_first", "diagnostic": ""},
                    {"key": "hide_bed", "text": "hide under the bed", "slot": "at_first", "diagnostic": "문제가 생긴 뒤 Waggy가 보인 반응을 처음 상황으로 혼동합니다."},
                ],
        ...
        },
        {
            ...
            "interaction": {"promptMode": "word_unscramble", "items": ["flashlight.", "his", "Poco", "takes"], "correct": ["Poco", "takes", "his", "flashlight."]},
        ...
        },
        {
            ...
            "interaction": {
                ...
                "options": [
                    ...
                    option("B", "It is small.", 67, "방문자가 작다는 단서는 이해했지만 작은 동물이 kitten이라는 정체까지 연결하지 못합니다."),
                    option("C", "It is my pajamas.", 33, "앞선 오해의 원인을 새로운 방문자 장면에 다시 적용합니다."),
