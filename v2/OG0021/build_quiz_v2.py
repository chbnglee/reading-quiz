...
rows = [
    ...
    ["Q02", "Setting Slot Drag", "Setting", "Look at the first scene. Fill in the boxes.", "SC01 image + word cards", "who=chameleon / where=forest / at_first=loves changing colors", 100, "setting", "Weighted Slot Match", "Q02_SETTING"],
...
style_cell(ws["A11"], C_GREEN, False, "000000", 9).value = (
    "v2 uses story-flow question order while keeping one primary Story Grammar score per Q01-Q06. "
...
make_option_sheet(
    "Q07 - Synthesis MCQ | Main Idea / Whole Story Meaning",
    "Q07_SYNTHESIS",
    "What did Milo find out at the end?",
    [
...
style_cell(ws["A13"], C_GREEN, True).value = "Overall Reading Score = average(6 Story Grammar axes) x 0.8 + Synthesis x 0.2"
...
for r, row in enumerate(
    [
        ...
        ["Q02", "answered", "quiz_OG0021_v2_Q02_setting", "setting", "0-100", "partial", "slot_values, component_scores", "Setting gap if <70"],
